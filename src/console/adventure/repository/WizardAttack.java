...
/*
WizardAttack : 마법사(플레이어)의 공격 전략
 */
public class WizardAttack implements AttackRepository {
    @Override
    public void basicAttack(Player player, Enemy enemy) {
        System.out.println("      [syndra]: Evarte Statum");
    ...
    public void ultimate(Player player, Enemy enemy) {
        System.out.println("      [syndra]: Expelliarmus");
        player.damageDealt(enemy.getPower());
